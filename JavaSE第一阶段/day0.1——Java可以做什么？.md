...
2、语言健壮：Java的强类型机制、异常处理、垃圾的自动回收机制等都是Java程序健壮的性的重要保证
...
1、Java的核心机制：Java虚拟机（Java Virtual Machhine）
...
JRE的全称是（Java Runtime Enviroment）java运行时环境
...
2、通过运行java.exe文件对字节码文件进行执行【本质是：java.exe将.class文件装在到JVM机执行】
